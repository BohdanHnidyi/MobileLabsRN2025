...
const photoGallery = [
  require("./assets/Кіт1 (1).jpg"),
  require("./assets/Кіт1 (2).jpg"),
  require("./assets/Кіт1 (3).jpg"),
  require("./assets/Кіт1 (4).jpg"),
  require("./assets/Кіт1 (5).jpg"),
  require("./assets/Кіт1 (6).jpg"),
  require("./assets/Кіт1 (7).jpg"),
  require("./assets/Кіт1 (8).jpg"),
  require("./assets/Кіт1 (9).jpg"),
  require("./assets/Кіт1 (10).jpg"),
];
  ...
  render() {
    return (
      <View style={styles.footer}>
        <Text style={styles.footerText}>Гнідий Богдан Сергійович, ВТк-24-1</Text>
      </View>
    );
  }
}
